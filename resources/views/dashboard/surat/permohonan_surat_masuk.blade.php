                    ...
                    @foreach ($surats as $surat)
                        <tr>
                            ...
                            <td align="center">
                                ...
                                <a href="editbuku.php" class="btn btn-xs btn-info" title="Edit"><i class="fas fa-check"></i></a>
                                <a href="#" class="btn btn-xs btn-warning"><i class="fas fa-times" title="Hapus"></i></a>
                            </td>
                        </tr>
                    @endforeach
                  </tbody>

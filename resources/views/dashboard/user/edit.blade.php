...
<section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h3><i class="fas fa-plus"></i> Edit User</h3>
        </div>
        <div class="col-sm-6">
        ...
        <form class="form-horizontal" method="post" action="{{ route('user.update', $user->id) }}" enctype="multipart/form-data">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-7">
                        <input type="text" class="form-control" name="no_kk" id="no_kk" value="{{ $user->no_kk ?? '' }}">
                        @error('no_kk')
                            <p style="color: red">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-7">
                        ...
                        <p style="color: gray;">jika tidak ingin merubah password cukup kosongkan</p>
                        @error('password')
                            <p style="color: red">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div class="card-footer">
                ...
                <a href="{{ route('user.index') }}" class="btn btn-default float-right">Batal</a>
            </div>
            <!-- /.card-footer -->
        </form>
    </div>
